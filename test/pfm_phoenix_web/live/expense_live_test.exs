defmodule PfmPhoenixWeb.ExpenseLiveTest do
  use PfmPhoenixWeb.ConnCase

  import Phoenix.LiveViewTest
  import PfmPhoenix.TransactionsFixtures

  @create_attrs %{date: "2024-09-19", description: "some description", category: "some category", amount: "120.5"}
  @update_attrs %{date: "2024-09-20", description: "some updated description", category: "some updated category", amount: "456.7"}
